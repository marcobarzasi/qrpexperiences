...
const state = reactive({
  ...
  //levels:[50,100,150,200,250,500,750,1000],
...
const make = () => {
  window.open('/server/api/Api.php?service=attestati.make&id=QSO.png&level=' + props.maxLevel + '&call=' + globalState.user.call, '_blank');
}
